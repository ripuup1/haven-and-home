...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Overlay */}
      <div
        className={`fixed inset-0 z-[100] bg-charcoal/40 backdrop-blur-sm transition-opacity duration-300 md:hidden ${
      ...
      <div
        className={`fixed top-0 right-0 z-[110] h-full w-72 bg-cream shadow-xl transition-transform duration-300 ease-in-out md:hidden ${
        ...
        <div className="flex h-full flex-col px-6 pt-24 pb-6">
          ...
          <div className="mt-auto border-t border-clay/20 pt-6">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 font-body text-sm text-medium-gray transition-colors hover:text-terracotta"
            >
              <svg
                width="16"
                height="16"
